<div class="mx-auto max-w-md rounded-2xl border border-slate-800 bg-slate-900 p-6 sm:p-8">
    ...
    <p class="mt-1 text-sm text-slate-400">Crie a conta e comece agora: 7 dias de teste com 3 análises de IA. Sem espera. Depois, se quiser mais, fale com o atendente no WhatsApp.</p>
